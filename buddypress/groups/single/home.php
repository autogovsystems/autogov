...
<div id="buddypress">
	...
	<div id="item-header" role="complementary" class="container-fluid cardtab">
	...
	<div id="item-group" class="container-fluid cardtab">
	<div id="item-nav">
		<div class="item-list-tabs no-ajax col-12 px-0" id="object-nav" aria-label="<?php esc_attr_e( 'Group primary navigation', 'buddypress' ); ?>" role="navigation">
			<ul class="row tab">
