 ...
 */
function this_update_termmeta_cache($term_ids) {
 ...
 */
function _add_term_meta( $term_id, $meta_key, $meta_value, $unique = false ) {
 ...
 * @return bool False for failure. True for success.
 */
function _delete_term_meta( $term_id, $meta_key, $meta_value = '' ) {
 ...
 *  is true.
 */
function _get_term_meta( $term_id, $key, $single = false ) {
 ...
 */
function _update_term_meta( $term_id, $meta_key, $meta_value, $prev_value = '' ) {
...
function get_term_custom( $term_id ) {
	...
	if ( ! wp_cache_get($term_id, 'term_meta') )
		this_update_termmeta_cache($term_id);
