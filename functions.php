...
add_filter('comment_form_defaults',function($d){
  ...
  }else if(get_post_type($post) == 'answer'){
...
?>
  ...
  <?php $user = get_user_by('email',get_comment_author_email());
  ...
  <?php endif; ?>
	...
	<div class="comment-meta commentmetadata <?php if($args['has_children']){ ?>col-8<?php }else{ ?>col-10<?php } ?>">
    <?php comment_text() ?>
...
?>
  ...
  <?php }*/ ?>
    ...
    <div class="comment-author vcard">
    	<div><?php $user = get_user_by('email',get_comment_author_email());
      printf(__('<cite class="fn">%s</cite>'), bp_core_get_userlink( $user->ID )); ?>
