...
<div class="col-6 mx-auto">
		...
		<?php if ( !get_option( 'open_register' )) : ?>
			<?php _e('Private community. Ask administrators for register.','autogov'); ?>
		<?php endif; ?>
	</div>

<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' &&  get_option( 'open_register' )) : ?>
