...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		...
		<?php else : ?>
			<h2 class="woocommerce-noreviews"><?php _e( 'There are no reviews yet.', 'woocommerce' ); ?></h2>
		<?php endif; ?>
	</div>
	...
	<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
		<div id="review_form_wrapper">
			<div id="review_form">
				...
				$comment_form = array(
					'title_reply'          => have_comments() ? __( 'Add a review', 'woocommerce' ) : sprintf( __( '<strong>Be the first to review</strong><br/>&ldquo;%s&rdquo;', 'woocommerce' ), get_the_title() ),
