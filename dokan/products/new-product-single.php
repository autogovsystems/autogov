                    ...
                    <form class="dokan-product-edit-form" role="form" method="post">
                        ...
                        <div class="dokan-form-top-area">
                            ...
                            <div class="content-half-part dokan-product-meta">
                                ...
                                <?php $tipo_articulo = get_post_meta( $post_id, 'tipo', true ); ?>
                                <label for="tipo_articulo" class="form-label"><?php _e( 'Article type', 'dokan-lite' ); ?></label>
                                <div class="dokan-form-group">
                                    <select name='tipo' id='tipo' class="dokan-form-control dokan-select2">
                                       <option value='producto' <?php if ($tipo_articulo == 'producto') echo "selected='selected'"; ?>><?php _e('Product','autogov'); ?></option>
                                       <option value='servicio' <?php if ($tipo_articulo == 'servicio') echo "selected='selected'"; ?>><?php _e('Service','autogov'); ?></option>
                                       <option value='evento' <?php if ($tipo_articulo == 'evento') echo "selected='selected'"; ?>><?php _e('Event','autogov'); ?></option>
                                    </select>
                                </div>
