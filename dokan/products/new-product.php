                    ...
                    <form class="dokan-form-container" method="post">
                        ...
                        <div class="product-edit-container dokan-clearfix">
                            ...
                            <div class="content-half-part dokan-product-meta">
                                <div class="dokan-form-group md-form">
                                    <input class="dokan-form-control form-control " name="post_title" id="post-title" type="text" value="<?php echo dokan_posted_input( 'post_title' ); ?>">
                                    <label for="post-title"><?php esc_attr_e( 'Product name', 'autogov' ); ?></label>
                                    <i class="fa fa-question-circle tips" title="<?php _e( "Add your product name", 'autogov' );?>" data-placement="left" aria-hidden="true"></i>
                                </div>
                                ...
                                <div class="dokan-form-group md-form">
                                    ...
                                    <textarea name="post_excerpt" rows="5" type="text" id="post-excerpt" class="md-textarea form-control"  maxlength="140" required><?php echo dokan_posted_textarea( 'post_excerpt' ); ?></textarea>
                                    <label for="post_excerpt" class=""><?php esc_attr_e( 'Short description of the product', 'autogov' ); ?></label>
                                    <i class="fa fa-question-circle tips textarea-tips"  title="<?php _e( "Add short description of the product", 'autogov' );?>" data-placement="left" aria-hidden="true"></i>
                                ...
                                <div class="dokan-form-group">
                                    <select name='tipo' id='tipo' class="dokan-form-control dokan-select2">
                                        <option data-placeholder="<?php _e( 'Select type', 'dokan-lite' ); ?>"><?php _e( 'Select type', 'dokan-lite' ); ?></option>
                                        <option value='producto'><?php _e('Product','autogov'); ?></option>
                                        <option value='servicio'><?php _e('Service','autogov'); ?></option>
                                        <option value='evento'><?php _e('Event','autogov'); ?></option>
                                    </select>
                                </div>
